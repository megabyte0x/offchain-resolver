...
module.exports = async ({deployments}) => {
    ...
    await registry.setSubnodeOwner(ethers.utils.namehash('eth'), ethers.utils.id('bico'), owner, {from: owner});
    await registry.setResolver(ethers.utils.namehash('bico.eth'), resolver.address, {from: owner});
};
